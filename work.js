...
const _filter_cheap = items.filter((Element) => Element.price <= 500)
console.log(_filter_show)

// 2. Filter and show the product that will be expensive in the array
const _filter_expensive = items.filter((Element) => Element.price > 500)
console.log(_filter_expensive)

// 3. Calculate the full price of all products combined
const summation = items.reduce((a, b) =>  {return a + b.price;}, 0)
console.log(summation)

// 4. Calculate the full price of all products combined and remove products that are under $10
const _under = items.filter((Element) => Element.price > 10)
const _summation = _under.reduce((a, b) =>  {return a + b.price;}, 0)
console.log(_summation)

// 5. Filter and show the product that will be start with letter b at first postion
const _first_position = items.filter((Element) => {return Element.name.charAt(0).toLowerCase() == 'b'})
